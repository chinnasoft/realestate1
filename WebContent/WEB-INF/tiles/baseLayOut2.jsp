  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li> <a href="userRegistrationList.html">
        ...
        <li>
          <a href="project-data.html">
            <i class="fa fa-th"></i> <span> Projects  List </span>
            <span class="pull-right-container">
         ...
         <a href="editors.html">
          ...
          <li>
       <a href="blank.html">
            <i class="fa fa-edit"></i> <span>Payment Getway</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
       ...
       <a href="profile.html">
        ...
        <li class="treeview">
          <a href="blank.html">
            <i class="fa fa-share"></i> <span>ERP - Billing </span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
      ...
      <div class="row">
        ...
        <section class="col-lg-5 connectedSortable">
          ...
          <div class="box box-solid bg-light-blue-gradient">
            ...
            <div class="box-body">
              <div id="world-map" style="height: 190px; width: 100%;"></div>
            </div>
            <!-- /.box-body-->
          ...
          <div class="box box-solid bg-green-gradient">
            ...
            <div class="box-body no-padding">
              <!--The calendar -->
              <div id="calendar" style="width: 100%; height:280px;"></div>
            </div>
            <!-- /.box-body -->
